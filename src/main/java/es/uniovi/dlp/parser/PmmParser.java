...
public class PmmParser extends Parser {
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 131941860376584L) != 0)) {
				{
				{
				setState(41);
		...
		try {
			...
			case 2:
				...
				if ( !(_la==T__16 || _la==T__17) ) {
				 ...
				 ((ExpStmtContext)_localctx).ast =  new AssignmentOperator( ((ExpStmtContext)_localctx).expression.ast, (((ExpStmtContext)_localctx).OP!=null?((ExpStmtContext)_localctx).OP.getText():null), ((ExpStmtContext)_localctx).expression.ast.getLine(), ((ExpStmtContext)_localctx).expression.ast.getColumn() ); 
				}
				break;
			}
		}
	...
	public final Func_callContext func_call() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 131941797986312L) != 0)) {
				{
				setState(272);
