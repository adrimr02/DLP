...
public class LexerTest {
	...
	private static LexicalInfo[] expectedTokens = new LexicalInfo[] {
			...
			new LexicalInfo(16, 5, "var1", PmmLexer.IDENT, "var1"),
			new LexicalInfo(16, 11, "_var_1", PmmLexer.IDENT, "_var_1"),
			new LexicalInfo(16, 19, "VAR_1_AB_2", PmmLexer.IDENT, "VAR_1_AB_2"),
